    ...
    */
    'vendors' => [
        ...
        'bdcom' => [
            ...
            'distance_unit' => 'm',
            'oids' => [
                // BDCOM enterprise 3320 (EPON/GPON). Verify per firmware.
                'onu_index' => '1.3.6.1.4.1.3320.101.10.1.1.1',
                'serial' => '1.3.6.1.4.1.3320.101.10.1.1.3',
                'run_status' => '1.3.6.1.4.1.3320.101.10.1.1.26',
                'distance' => '1.3.6.1.4.1.3320.101.10.1.1.30',
                'rx_power' => '1.3.6.1.4.1.3320.101.108.1.1.1',
                'tx_power' => '1.3.6.1.4.1.3320.101.108.1.1.2',
                'description' => '1.3.6.1.4.1.3320.101.10.1.1.9',
                'mac' => '1.3.6.1.4.1.3320.101.10.1.1.2',
                'online_since' => '1.3.6.1.4.1.3320.101.10.1.1.27',
            ],
        ],
